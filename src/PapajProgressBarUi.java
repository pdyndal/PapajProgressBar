...
public class PapajProgressBarUi extends BasicProgressBarUI {
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) PapajIcons.CAT_ICON) : ((ScalableIcon) PapajIcons.RCAT_ICON) ;
//        if (velocity < 0) {
...
//        g2.setColor(progressBar.getForeground());
        ...
        PapajIcons.CAT_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
